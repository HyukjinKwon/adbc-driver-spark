// Code generated by .hjk_work/gen/_tmpl/driver.go.tmpl. DO NOT EDIT.
...
// const char* SparkArrayStreamGetLastError(struct ArrowArrayStream*);
// void SparkArrayStreamRelease(struct ArrowArrayStream*);
//
// int SparkArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int SparkArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
var drv = spark.NewDriver(mallocator.NewMallocator())
...
const logLevelEnvVar = "ADBC_DRIVER_SPARK_LOG_LEVEL"
...
func setErr(err *C.struct_AdbcError, format string, vals ...interface{}) {
	...
	err.release = (*[0]byte)(C.Spark_release_error)
}
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_SparkError, C.size_t(1))
	cErr := (*C.struct_SparkError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.SparkReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "Spark driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in Spark driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("Spark does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "Spark: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.SparkerrRelease(cStream.adbcErr)
		} else {
...
//export SparkArrayStreamGetLastError
func SparkArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.SparkArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export SparkArrayStreamGetNext
func SparkArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.SparkArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export SparkArrayStreamGetSchema
func SparkArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.SparkArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export SparkArrayStreamRelease
func SparkArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.SparkArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export SparkErrorFromArrayStream
func SparkErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.SparkArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.SparkArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.SparkArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.SparkArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.SparkArrayStreamRelease)
...
//export SparkDatabaseGetOption
func SparkDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseGetOptionBytes
func SparkDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseGetOptionDouble
func SparkDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseGetOptionInt
func SparkDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseInit
func SparkDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseNew
func SparkDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseRelease
func SparkDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export SparkDatabaseSetOption
func SparkDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseSetOptionBytes
func SparkDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseSetOptionDouble
func SparkDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkDatabaseSetOptionInt
func SparkDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetOption
func SparkConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetOptionBytes
func SparkConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetOptionDouble
func SparkConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetOptionInt
func SparkConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionNew
func SparkConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionSetOption
func SparkConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionSetOptionBytes
func SparkConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionSetOptionDouble
func SparkConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionSetOptionInt
func SparkConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionInit
func SparkConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionRelease
func SparkConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionCancel
func SparkConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetInfo
func SparkConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetObjects
func SparkConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export SparkConnectionGetStatistics
func SparkConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetStatisticNames
func SparkConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export SparkConnectionGetTableSchema
func SparkConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionGetTableTypes
func SparkConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionReadPartition
func SparkConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionCommit
func SparkConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkConnectionRollback
func SparkConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementGetOption
func SparkStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementGetOptionBytes
func SparkStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementGetOptionDouble
func SparkStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementGetOptionInt
func SparkStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementNew
func SparkStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementRelease
func SparkStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementCancel
func SparkStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementPrepare
func SparkStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementExecuteQuery
func SparkStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementExecuteSchema
func SparkStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export SparkStatementSetSqlQuery
func SparkStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementSetSubstraitPlan
func SparkStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementBind
func SparkStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementBindStream
func SparkStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementGetParameterSchema
func SparkStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementSetOption
func SparkStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementSetOptionBytes
func SparkStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementSetOptionDouble
func SparkStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementSetOptionInt
func SparkStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export SparkStatementExecutePartitions
func SparkStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export AdbcDriverSparkInit
func AdbcDriverSparkInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.SparkDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.SparkDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.SparkDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.SparkDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.SparkConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.SparkConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.SparkConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.SparkConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.SparkConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.SparkConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.SparkConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.SparkConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.SparkConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.SparkConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.SparkConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.SparkStatementNew)
	driver.StatementRelease = (*[0]byte)(C.SparkStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.SparkStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.SparkStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.SparkStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.SparkStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.SparkStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.SparkStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.SparkStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.SparkStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.SparkStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.SparkErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.SparkErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.SparkErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.SparkDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.SparkDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.SparkDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.SparkDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.SparkDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.SparkDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.SparkDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.SparkConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.SparkConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.SparkConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.SparkConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.SparkConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.SparkConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.SparkConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.SparkConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.SparkConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.SparkConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.SparkStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.SparkStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.SparkStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.SparkStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.SparkStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.SparkStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.SparkStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.SparkStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.SparkStatementSetOptionInt)
	}
